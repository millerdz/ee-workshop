# Deploying Applications with Docker Enterprise
...
### <a name="task3.4"></a> Task 3.4: Get the DataDog Java Agent, Modify pom.xml and Dockerfile to enable DataDog APM
...
## <a name="task5"></a>Task 5: Deploy the App to Kubernetes
